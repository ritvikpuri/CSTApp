...
public class WordAssociationQ2 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_word_association_q2);
        Button indi = findViewById(R.id.btnIncorrect1);
        indi.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(WordAssociationQ2.this, WordAssociationQ3.class);
        ...
        Button wrong1 = findViewById(R.id.btnCorrect);
