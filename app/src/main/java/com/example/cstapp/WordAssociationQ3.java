...
public class WordAssociationQ3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_word_association_q3);
        Button indi = findViewById(R.id.btnIncorrect1);
        indi.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(WordAssociationQ3.this, WordAssociationQ4.class);
