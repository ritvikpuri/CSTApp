...
public class WordAssociationQ5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_word_association_q5);
        Button indi = findViewById(R.id.btnCorrect);
        indi.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(WordAssociationQ5.this, WordAssociationEnd.class);
        ...
        Button wrong1 = findViewById(R.id.btnIncorrect2);
        ...
        Button wrong2 = findViewById(R.id.btnIncorrect1);
